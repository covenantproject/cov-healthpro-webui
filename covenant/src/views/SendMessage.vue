    ...
    <div class="box">
      <form>
        <div class="row">
          ...
          <div class="col-75">
            <textarea
              ...
              rows="4"
              name="email"
              :class="[(submitted==false ? 'notsubmitted':((email==''||isemailvalid==false) && submitted ? 'error':'success'))]"
            ></textarea>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row" style="padding:10px;">
          <button
            type="button"
            style="float:right;width:10%;padding:8px;"
            class="btn btn-default"
            v-on:click="sendMail(email,message)"
          >Send</button>
        </div>
      </form>
    </div>
