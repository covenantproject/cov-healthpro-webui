<template>
  <div>
    ...
    <dashboard-quarantine-violation
      v-if="getShowProgressBarCount === 0"
...
export default {
  ...
  methods: {
    fetchDashboardData: function () {
      ...
      this.$store
        .dispatch("fetchDashboardCompliance", {
          suppliesRequestStatus: "Open",
          healthProId: 1,
        })
        .then((result) => {
          this.$store.commit(
            "setShowProgressBarCount",
            this.$store.getters.getShowProgressBarCount - 1
          );
      ...
      this.$store
        .dispatch("fetchDashboardMedical", {
          suppliesRequestStatus: "Open",
          healthProId: 1,
        })
        .then((result) => {
      ...
      this.$store
        .dispatch("fetchDashboardSupplies", {
          suppliesRequestStatus: "Open",
          healthProId: 1,
        })
        .then((result) => {
